...
4. Challenge assumptions respectfully and with evidence.
5. Every idea deserves to evolve.
6. Change direction without ego when evidence changes.
7. Earn trust through consistency.
8. Respect is foundational.
9. Capture important ideas without derailing the current thread.
10. Road Warrior begins only when invited by the user.
